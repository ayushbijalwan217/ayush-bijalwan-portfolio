...
const PROJECTS = [
  ...
  { title: 'Product Advertisement', category: 'Video Editing', software: ['Premiere Pro', 'After Effects'], desc: 'Cinematic product spot with studio-grade color, macro detail and punchy sound.', role: 'Editor', client: 'D2C Brand', duration: '3 weeks', workflow: 'Assembly -> Edit -> Color -> Sound -> Master', video: 'https://images.unsplash.com/photo-1652992252915-f9b6592a61a3?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0', video: '/videos/Product-Advertisement-edit.mp4', aspect: '9/16' },
